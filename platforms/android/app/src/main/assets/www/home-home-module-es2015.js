...
/* harmony import */ var paho_mqtt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! paho-mqtt */ "./node_modules/paho-mqtt/paho-mqtt.js");
/* harmony import */ var paho_mqtt__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(paho_mqtt__WEBPACK_IMPORTED_MODULE_3__);
...
let HomePage = class HomePage {
    ...
    connectToMQTTBroker(hostname, port, id) {
        let options = {
            timeout: 60,
            useSSL: true,
    ...
    sendMessage() {
        ...
        let message = new paho_mqtt__WEBPACK_IMPORTED_MODULE_3__["Message"](value);
    ...
    startListening() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.acceleration_subscriber = new _ionic_native_device_motion_ngx__WEBPACK_IMPORTED_MODULE_2__["DeviceMotion"]()
                .watchAcceleration(option)
                .subscribe((acceleration) => {
                console.log("get message");
                this.getAccelerationData(acceleration);
                if (this.sendingMQTTFlag == true &&
                    this.mqttBrokerConnectFlag == true) {
                    this.sendMessage();
                }
            });
    ...
    getAccelerationData(acceleration) {
