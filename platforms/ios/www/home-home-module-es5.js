...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  /***/
  function node_modulesPahoMqttPahoMqttJs(module, exports, __webpack_require__) {
    /*******************************************************************************
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var paho_mqtt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! paho-mqtt */
    "./node_modules/paho-mqtt/paho-mqtt.js");
    /* harmony import */


    var paho_mqtt__WEBPACK_IMPORTED_MODULE_3___default =
    /*#__PURE__*/
    __webpack_require__.n(paho_mqtt__WEBPACK_IMPORTED_MODULE_3__);
    ...
    function () {
      ...
      _createClass(HomePage, [{
        key: "connectToMQTTBroker",
        value: function connectToMQTTBroker(hostname, port, id) {
          var options = {
            timeout: 60,
            useSSL: false,
          ...
          this.client = new paho_mqtt__WEBPACK_IMPORTED_MODULE_3__["Client"](hostname, port, id);
        ...
        value: function disconnectMQTTBroker() {
        ...
        value: function sendMessage() {
          ...
          var message = new paho_mqtt__WEBPACK_IMPORTED_MODULE_3__["Message"](value);
          message.destinationName = "telegraf/t";
          this.client.send(message); //Test section 
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    this.acceleration_subscriber = new _ionic_native_device_motion_ngx__WEBPACK_IMPORTED_MODULE_2__["DeviceMotion"]().watchAcceleration(option).subscribe(function (acceleration) {
                      console.log("get message");

                      _this.getAccelerationData(acceleration);

                      if (_this.sendingMQTTFlag == true && _this.mqttBrokerConnectFlag == true) {
                        _this.sendMessage();
                      }
                    });
        ...
        key: "getAccelerationData",
        value: function getAccelerationData(acceleration) {
        ...
        key: "sendOneTime",
        value: function sendOneTime() {
          console.log("send one time");
          this.sendMessage();
        }
      }, {
        key: "clearUrlNPort",
        value: function clearUrlNPort() {
          this.mqtt_port = null;
          this.mqtt_url = "";
        }
      }, {
        key: "connectMQTTBroker",
        value: function connectMQTTBroker() {
          ...
          this.connectToMQTTBroker(this.mqtt_url, this.mqtt_port, "Client_Tablet"); // this.clearUrlNPort();
        }
      }, {
        key: "enableSending",
        value: function enableSending(event) {
